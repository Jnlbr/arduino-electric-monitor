...
const char* ADD_PARAM = "http://192.168.0.111:10036/hardware/params/add";
const char* UPDATE_ACTIVE = "http://192.168.0.111:10036/hardware/update/active";
const char* CHANGE_EVENT = "stateChange:21";
